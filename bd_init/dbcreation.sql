...
USE phoneShop;
CREATE TABLE IF NOT EXISTS Users(id_user INT NOT NULL AUTO_INCREMENT, email VARCHAR(50) not null, prenom VARCHAR(50) not null, nom VARCHAR(50) not null,    motDepass VARCHAR(100) NOT NULL, PRIMARY KEY (id_user));
